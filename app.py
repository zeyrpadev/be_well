            ...
            with st.container(border=True):
                ...
                for case in cases:
                    ...
                    with img_col:
                        if photo_url:
                            st.markdown(
                                f'<img src="{photo_url}" style="width:80px;height:80px;object-fit:cover;border-radius:14px;margin-top:10px;">',
                                unsafe_allow_html=True,
                            )
                        else:
                            st.markdown(
                                '<div style="width:80px;height:80px;border-radius:14px;background:#e8e8e8;margin-top:10px"></div>',
                                unsafe_allow_html=True,
                            )
